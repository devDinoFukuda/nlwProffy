...
async function pageStudy(req, res) {
    ...
    if (!filters.subject || !filters.weekday || !filters.time) {
        const proffys = ""
        console.log("TEM campos vazios", filters.subject, filters.weekdays, filters.time)
        return res.render("study.html", {proffys, filters, subjects, weekdays })
    }
    console.log("*NÃO* tem campos vazios", filters.subject, filters.weekdays, filters.time)
